...
p_tot   = p_gs   + p_exp_mumu   + p_gs_ah   + p_gs_eta   + p_gs_rho   + p_gs_phi   + p_CB_Jpsi   + p_gs_psi
p_tut_d = p_gs_d + p_exp_mumu_d + p_gs_ah_d + p_gs_eta_d + p_gs_rho_d + p_gs_phi_d + p_CB_Jpsi_d + p_gs_psi_d
p_tut_u = p_gs_u + p_exp_mumu_u + p_gs_ah_u + p_gs_eta_u + p_gs_rho_u + p_gs_phi_u + p_CB_Jpsi_u + p_gs_psi_u
...
#plt.bar(bin_centres, hist, width=0.005, label='Test data', yerr=np.sqrt(hist))
